export const TermsServicesData = {
  ...
  sections: [
    ...
    {
      id: "limited-scope",
      title: "Limited Scope and Follow-Ups",
      content: [
    ...
    {
      id: "trademark-filing",
      title: "Trademark Filing & Client Authorization",
      content: [
    ...
    {
      id: "specimens",
      title: "Specimens and Intent-to-Use Applications",
      content: [
    ...
    {
      id: "deadlines",
      title: "Deadlines & Time Sensitivity",
      content: [
    ...
    {
      id: "future-conflicts",
      title: "Future Conflicts & Representing Other Clients",
      content: [
