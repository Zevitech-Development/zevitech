...
import { Cta03Props } from "@/interfaces/common-interfaces";
...
function Cta03({ image, heading, text }: Cta03Props) {
  return (
    <section className="section-padding-standard ">
      <div className="layout-standard grid lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="flex flex-col gap-6">
          <h1 className="text-4xl md:text-5xl leading-relaxed font-extrabold text-heading max-w-4xl">
            {heading}
          </h1>
