...
export default function WhatsAppPopup({
  bodyMessage = "👋 Hi there! Need help with your logo design?",
  supportMessage = "Chat with us on WhatsApp for instant support!",
      ...
      <div className="bg-white rounded-lg shadow-2xl w-80 overflow-hidden">
        ...
        <div className="bg-[#25D366] p-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-white font-semibold text-sm">Zevitech</h3>
        ...
        <div className="p-4 bg-gray-50">
          <div className="bg-white rounded-lg p-3 shadow-sm mb-3">
            <p className="text-paragraph text-sm">{bodyMessage}</p>
            <p className="text-paragraph text-xs mt-2">{supportMessage}</p>
          </div>

          <button
            onClick={handleWhatsAppClick}
            className="w-full bg-[#25D366] hover:bg-[#20BA5A] text-white font-medium py-3 px-4 rounded-lg transition-colors flex items-center justify-center gap-2"
          >
            <svg
              className="w-5 h-5"
              fill="currentColor"
