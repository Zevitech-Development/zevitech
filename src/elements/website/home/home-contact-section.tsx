          ...
          <div className="grid md:grid-cols-2 items-center gap-10">
            <div className="space-y-6">
              ...
              <div className="relative">
                ...
                />
                <User className="absolute left-3 top-1/2 transform -translate-y-1/2 text-primary h-5 w-5 mr-2" />
              ...
              <div className="relative">
                ...
                />
                <Mail className="absolute left-3 top-1/2 transform -translate-y-1/2 text-primary h-5 w-5 mr-2" />
              ...
              <div className="relative">
                ...
                />
                <Edit3 className="absolute left-3 top-6 text-primary h-5 w-5 mr-2" />
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  {services.map((service) => (
                    <Button
                      ...
                      className={cn(
                        "text-xs lg:text-sm py-2 px-4 rounded-full transition-all duration-200",
                        selectedServices.includes(service)
                ...
                {form.formState.errors.services && (
                  <p className="text-red-400 text-sm mt-2">{form.formState.errors.services.message}</p>
                )}
              </div>
              ...
              <div className="relative">
                ...
                />
                <DollarSign className="absolute left-3 top-1/2 transform -translate-y-1/2 text-primary h-5 w-5" />
