...
export const metadata: Metadata = GetPageMetadata({
  ...
  path: "/services/ecommerce/woocommerce-website-development",
});

function WooCommerceWebsiteDevelopment() {
  return (
    <>
      <JsonLd data={buildServiceSchema("/services/ecommerce/woocommerce-website-development", "WooCommerce Website Development")} />
      <WooCommerceWebsiteDevelopmentPage />
    </>
  );
}
